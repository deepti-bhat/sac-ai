...
for round_num in range(num_rounds):
    ...
    # Track training accuracy and loss for each round
    ...
    for client_idx, client_data in enumerate(client_datasets):
        ...
        # Evaluate client model on its local data (calculate training accuracy and loss)
        train_accuracy, train_loss, _, _, _, _ = evaluate_model(client_model, client_loader)
        round_train_accuracies.append(train_accuracy)
        round_train_losses.append(train_loss)

    # Meta-update the global model using adapted client models
