...
# Testing the Global Model (with precision, recall, and f1-score)
...
def train_federated(num_clients=10, num_rounds=20, lr=0.01, noise_multiplier=0.1, max_grad_norm=1.0, device='cpu'):
    ...
    for round in range(num_rounds):
        ...
        # Federated Averaging with optional weighting based on data size
